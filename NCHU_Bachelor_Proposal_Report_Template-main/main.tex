...
% 论文中文题目
\newcommand{\thesisTitle}{基于基带信号发送滤波理论的图像处理方法研究}
% 论文英文题目（可选）
...
\newcommand{\yourName}{李奕澄}
\newcommand{\yourStudentID}{19084129}
...
% 按二级标题添加
% 选题的依据及意义
\input{sections/1_rationale_significance.tex}
% 国内外研究概况和发展趋势
\input{sections/2_overview_trend.tex}
% 研究内容及实验方案
\input{sections/3_research_content.tex}
% 目标、主要特色及工作进度
\input{sections/4_objectives.tex}
% 参考文献
