...
\begin{titlepage}
  ...
  \includegraphics[width=11cm]{images/header_cut.png}
  % \includegraphics[width=11.23cm]{images/header.png}

  \vspace*{26mm}

  \zihao{-0}\textbf{\songti{毕业设计（论文）开题报告}}

  \vspace{20mm}

  \hspace{1.3mm}\heiti\zihao{3}\selectfont{\textbf{题\hspace{10mm}目：\dunderline[-10pt]{1pt}{\makebox[120mm][l]{\thesisTitle}}}}
  ...
  \vspace{25mm}
  \centering
  \zihao{-3}\songti{填表日期\hspace{2.8mm}\today}
\end{titlepage}
